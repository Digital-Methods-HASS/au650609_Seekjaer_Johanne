---
title: "Are_we_more_civilized_today?"
author: "Johanne Seekjær"
...
Western_Europe_plotting %>% 
  ggplot(aes(x=Year, y=homicide_per_100k, color=Entity))+
  geom_line()+
...
Answer: While there are many more linked factors when determining if a country is civilised than the homicide rate, it is a good place to start. The graph above shows how the homicide rate has changed over time in several western European countries. This firstly means that our conclusion is limited to these, we cannot say much about fx America. There is a general trend among these western European countries, that the homicide rate starts to drastically decrease by the 1500-1600 hundred and remains for the most part in a continuous decline. This would suggest a trend towards a more civilised way of life and more civilised societies with things like stronger and more organised justice systems, more stable governments, and new ideologies. In the case of Denmark we also have the duration of the monarch's reign to compare to. While a direct link between homicide and duration of reign is highly unlikely, you could argue that the trend of longer duration over time shows some of the same underlying factors responsible for a decrease in homicide. The main example being a more stable government. As a conclusion you could argue that the declining homicide rate as shown in the visualisation above points towards a more civilised society in western europe today than in the 1400 hundreds. 